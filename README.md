...
<p> How can we pacify this ongoing problem I hear you cry, I am no expert and these are only suggestions? <p>
 <p> <p>
<ul>
  <li>First item</li>Launch internship programs to attract more diverse talent and to expand the pool of creatives with different backgrounds and perspectives  ~~Strikethrough text~~ PS no experience or age limit is needed just passion.
 <li>Second item</li>
